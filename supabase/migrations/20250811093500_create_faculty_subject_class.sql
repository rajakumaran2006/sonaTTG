-- Create faculty_subject_class junction table for precise faculty-subject-year-section mappings
...
-- Open policies (adjust when auth is added)
do $$
begin
...
-- Maintain updated_at if helper exists
do $$
begin
