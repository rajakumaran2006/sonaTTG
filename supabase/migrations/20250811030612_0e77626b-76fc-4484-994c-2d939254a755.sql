...
-- Allow public access (no auth yet) - adjust later when auth is added
create policy if not exists "Departments are publicly readable"
  on public.departments for select
  using (true);
create policy if not exists "Departments are publicly insertable"
  on public.departments for insert
  with check (true);
create policy if not exists "Departments are publicly updatable"
  on public.departments for update
  using (true);
create policy if not exists "Departments are publicly deletable"
...
create policy if not exists "Subjects are publicly readable"
  on public.subjects for select
  using (true);
create policy if not exists "Subjects are publicly insertable"
  on public.subjects for insert
  with check (true);
create policy if not exists "Subjects are publicly updatable"
  on public.subjects for update
  using (true);
create policy if not exists "Subjects are publicly deletable"
...
create policy if not exists "Timetables are publicly readable"
  on public.timetables for select using (true);
create policy if not exists "Timetables are publicly upsertable"
  on public.timetables for insert with check (true);
create policy if not exists "Timetables are publicly updatable"
  on public.timetables for update using (true);
create policy if not exists "Timetables are publicly deletable"
...
create trigger if not exists trg_lab_prefs_updated_at
before update on public.lab_preferences
for each row execute function public.update_updated_at_column();

alter table public.lab_preferences enable row level security;

create policy if not exists "Lab prefs are publicly readable"
  on public.lab_preferences for select using (true);
create policy if not exists "Lab prefs are publicly insertable"
  on public.lab_preferences for insert with check (true);
create policy if not exists "Lab prefs are publicly updatable"
  on public.lab_preferences for update using (true);
create policy if not exists "Lab prefs are publicly deletable"
